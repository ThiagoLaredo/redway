...
export const initPageLoadAnimations = () => {
  const pageElements = [
    ...
    { selector: ".introducao-texto h1, .introducao-texto p, .introducao-texto button, .servicos-lista, .logo-fiquealerta", props: { duration: 1, x: -100, opacity: 0, stagger: 0.2, ease: "power1.out", delay: 2 } },
